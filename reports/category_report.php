...
<body><nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../reports/category_report.php">Category Report</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <h1 class="mt-5">Category Report</h1>
        <form action="category_report.php" method="POST">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "SELECT * FROM asset WHERE category = '$category'";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<h2 class='mt-4'>Report for Category: $category</h2>
                ...
                echo "<p>No records found for Category: $category</p>";
            }
