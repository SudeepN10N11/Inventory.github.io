...
<body><nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../reports/agent_report.php">Agent Report</a>
                </li>
            </ul>
            <ul class="navbar-nav">
                <li class="nav-item">
    ...
    <div class="container">
        <h1 class="mt-5">Agent Report</h1>
        <form action="agent_report.php" method="POST">
            ...
            <button type="submit" name="submit" class="btn btn-dark">Generate Report</button>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "SELECT * FROM asset 
                    INNER JOIN seize_order ON asset.asset_id = seize_order.asset_id 
                    WHERE seize_order.agent_id = $agent_id";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<h2 class='mt-4'>Report for Agent</h2>
                ...
                echo "<p>No records found for selected Agent</p>";
            }
